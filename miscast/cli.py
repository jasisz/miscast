...
def main():
    ...
    ap.add_argument("--mode", choices=list(MODES) + ["invalid"], default="replay",
                    help="replay/mutate (corpus), smith (random), the self-checking oracles "
                         "morphism/recgroup/externconvert/castbr/eh/exnstack/compose, invalid (spec-invalid "
                         "validation battery), or 'all' to run the whole oracle suite + the validation battery")
